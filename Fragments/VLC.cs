...
namespace Fragments
{
    ...
    static class LibVlc
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_set_fullscreen(IntPtr player, Int32 b_fullscreen);
    ...
    class VlcMedia : IDisposable
    {
        ...
        {
            Handle = LibVlc.libvlc_media_new_path(instance.Handle, path);
            if (Handle == IntPtr.Zero) throw new VlcException();
        }
    ...
    class VlcMediaPlayer : IDisposable
    {
        ...
        public bool IsPlaying() {
            return Convert.ToBoolean(LibVlc.libvlc_media_player_is_playing(Handle));           
        }
